...
# EXPOSE 5000
  # Memberitahu Docker bahwa container akan mendengarkan pada port 5000. Ini tidak membuka port secara otomatis, tetapi memberikan informasi kepada pengguna dan alat lain tentang port yang digunakan oleh aplikasi.
